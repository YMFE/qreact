...
function setResponderAndExtractTransfer(topLevelType, targetInst, nativeEvent, nativeEventTarget) {
    // for Responder topMouseMove only triggering after topMouseDown should listen
...
var ResponderEventPlugin = {
    isMouseDown: touchSupport, // to support PC
    ...
    extractEvents: function(topLevelType, targetInst, nativeEvent, nativeEventTarget) {
        switch (topLevelType) {
          case topMouseDown: ResponderEventPlugin.isMouseDown = true;break;
          // while using debugger tool detecting ele, only mouseup will trigger
          case topMouseUp: if (!ResponderEventPlugin.isMouseDown) return null;ResponderEventPlugin.isMouseDown = false;break;
        }
