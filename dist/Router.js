...
(function(global, factory) {
    ...
    function createHistory(source) {
        ...
        var target = {
            ...
            listen: function listen(listener) {
                ...
                var event =
                    modeObject.value === "hash" ? "hashchange" : "popstate";
    ...
    var LocationProvider = miniCreateClass(
        ...
        Component,
        {
            ...
            componentDidUpdate: function componentDidUpdate(
                ...
                if (
                    prevState.context.location !== this.state.context.location
                ) {
    ...
    function Router(props) {
        modeObject.value =
            supportPushState && (!props.mode || props.mode === "history")
                ? "history"
                : "hash";
        return React.createElement(BaseContext.Consumer, null, function(
            baseContext
        ) {
            return React.createElement(Location, null, function(
                locationContext
            ) {
                return React.createElement(
                    RouterImpl,
    ...
    var RouterImpl = miniCreateClass(
        function RouterImpl() {},
        PureComponent,
        {
            render: function render() {
    ...
    var FocusHandlerImpl = miniCreateClass(
        ...
        },
        {
            getDerivedStateFromProps: function getDerivedStateFromProps(
                ...
                if (initial) {
                    ...
                    var navigatedUpToMe =
                        prevState.location.getPath() !== nextPath &&
