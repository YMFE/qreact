        ...
        class ChildComponent extends React.Component {
            ...
            render() {
                ...
                return (
                    <div>
                        <button
                            onClick={this.handleHue.bind(this, "dark", "blue")}
                        >
                            Dark Blue
                        </button>
                        <button
                            onClick={this.handleHue.bind(this, "light", "blue")}
                        >
                            Light Blue
                        </button>
                        <button
                            onClick={this.handleHue.bind(this, "dark", "green")}
                        >
                            Dark Green
                        </button>
                        <button
                            onClick={this.handleHue.bind(
                                this,
                                "light",
                                "green"
                            )}
