...
describe("ReactMount", () => {
    ...
    describe("unmountComponentAtNode", () => {
        it("throws when given a non-node", () => {
            ...
            }).toThrow("container is not a element");
        });
    ...
    it(
        "initial mount is sync inside batchedUpdates, but task work is deferred until " +
    ...
    it("同一个元素节点中两个组件更新", () => {
        ...
        class App extends React.Component {
            ...
            render() {
                return (
                    <div ref="div">
                        <TextArea id="text1" value={values.shift()} />
                        <div id="div">{this.state.text}</div>
                        <Wrap>
                            <TextArea id="text2" value={values.shift()} />
                        </Wrap>
                    </div>
                );
            }
        ...
        class TextArea extends React.Component {
            ...
            render() {
                return <textarea id={this.props.id} value={this.props.value} />;
            }
        }
        ...
        expect(
            Array.from(instance.refs.div.children).map(function(el) {
                return el.id;
            })
