...
describe("ReactComponentLifeCycle", () => {
    ...
    it("should carry through each of the phases of setup", () => {
        class LifeCycleComponent extends React.Component {
            constructor(props, context) {
                ...
                this._testJournal.returnedFromGetInitialState = clone(
                    initState
                );
            ...
            UNSAFE_componentWillMount() {
                ...
                this._testJournal.lifeCycleAtStartOfWillMount = getLifeCycleState(
                    this
                );
            ...
            componentDidMount() {
                ...
                this._testJournal.lifeCycleAtStartOfDidMount = getLifeCycleState(
                    this
                );
            ...
            render() {
                ...
                if (isInitialRender) {
                    ...
                    this._testJournal.lifeCycleInInitialRender = getLifeCycleState(
                        this
                    );
                } else {
                    this._testJournal.stateInLaterRender = clone(this.state);
                    this._testJournal.lifeCycleInLaterRender = getLifeCycleState(
                        this
                    );
                }
        ...
        expect(instance._testJournal.lifeCycleAtStartOfWillMount).toBe(
            "UNMOUNTED"
        );
        ...
        // render 2nd time
        expect(instance._testJournal.stateInLaterRender).toEqual(
            NEXT_RENDER_STATE
        );
    ...
    it("should allow state updates in componentDidMount", () => {
        ...
        class SetStateInComponentDidMount extends React.Component {
            ...
            componentDidMount() {
                this.setState({
                    stateField: this.props.valueToUseInOnDOMReady
                });
            }
    ...
    it("should warn about deprecated lifecycles (cWM/cWRP/cWU) if new static gDSFP is present", () => {
        ...
        expect(() =>
            ReactDOM.render(<WillReceiveProps />, container)
        ).toWarnDev(
            "Unsafe legacy lifecycles will not be called for components using new component APIs.\n\n" +
            ...
            componentDidUpdate(prevProps, prevState, snapshot) {
                log.push(
                    `componentDidUpdate() prevProps:${
                        prevProps.value
                    } prevState:${prevState.value} snapshot:${snapshot}`
                );
            }
            render() {
                log.push("render");
    ...
    it("should call getSnapshotBeforeUpdate before mutations are committed", () => {
        ...
        class MyComponent extends React.Component {
            ...
            render() {
                log.push("render");
                return (
                    <div ref={this.divRef}>{`value:${this.props.value}`}</div>
                );
            }
        }
