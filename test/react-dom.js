  ...
  var ReactFiberClassComponent = function(
    ...
    var updater = {
      ...
      enqueueSetState: function(instance, partialState, callback) {
        ...
        var expirationTime = computeExpirationTimeForPriority(
          priorityLevel,
          currentTime
        );
        var update = {
  ...
  */
    ...
    function commitErrorLogging(finishedWork, onUncaughtError) {
      switch (finishedWork.tag) {
        ...
        case HostRoot: {
          ...
          !(_updateQueue3 !== null && _updateQueue3.capturedValues !== null)
            ? invariant_1(
              false,
              "An error logging effect should not have been scheduled if no errors were captured. This error is likely caused by a bug in React. Please file an issue."
            )
  ...
  var ReactFiberScheduler = function(config) {
    ...
    function renderRoot(root, expirationTime, isAsync) {
      ...
      if (
        ...
        nextRemainingTimeMs =
          expirationTimeToMs(nextRenderExpirationTime) -
      ...
      if (didFatal) {
        ...
        if (isRootReadyForCommit) {
          ...
          var firstUnblockedExpirationTime = findNextExpirationTimeToWorkOn(
            root
          );
  ...
  var ReactFiberReconciler$1 = function(config) {
    ...
    var _ReactFiberScheduler = ReactFiberScheduler(config),
      ...
      computeUpdatePriorityForFiber =
        _ReactFiberScheduler.computeUpdatePriorityForFiber,
      computeExpirationTimeForPriority =
        _ReactFiberScheduler.computeExpirationTimeForPriority,
