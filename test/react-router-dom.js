(function(global, factory) {
  ...
  var _resolvePathname =
    (resolvePathname$2 && resolvePathname) || resolvePathname$2;
  ...
  var createTransitionManager_1 = createCommonjsModule(function(
    module,
    exports
  ) {
    "use strict";
  ...
  var createBrowserHistory_1 = createCommonjsModule(function(module, exports) {
    ...
    var createBrowserHistory = function createBrowserHistory() {
      ...
      var needsHashChangeListener = !(0,
        DOMUtils.supportsPopStateOnHashChange)();
      ...
      var _props$forceRefresh = props.forceRefresh,
        ...
        getUserConfirmation =
          _props$getUserConfirm === undefined
            ? DOMUtils.getConfirmation
            : _props$getUserConfirm,
        _props$keyLength = props.keyLength,
        keyLength = _props$keyLength === undefined ? 6 : _props$keyLength;

      var basename = props.basename
        ? (0, PathUtils.stripTrailingSlash)(
          (0, PathUtils.addLeadingSlash)(props.basename)
        )
        : "";
      ...
      var checkDOMListeners = function checkDOMListeners(delta) {
        ...
        if (listenerCount === 1) {
          ...
          if (needsHashChangeListener)
            (0, DOMUtils.addEventListener)(
              window,
              HashChangeEvent,
              handleHashChange
            );
        } else if (listenerCount === 0) {
          (0, DOMUtils.removeEventListener)(
            window,
            PopStateEvent,
            handlePopState
          );
  ...
  var factoryWithTypeCheckers$2 = function(
    isValidElement,
    throwOnDirectAccess
  ) {
    /* global Symbol */
  ...
  var propTypes$1 = createCommonjsModule(function(module) {
...

    {
      ...
      // http://fb.me/prop-types-in-prod
      var throwOnDirectAccess = true;
      module.exports = factoryWithTypeCheckers$2(
        isValidElement,
        throwOnDirectAccess
      );
    }
  ...
  var BrowserRouter = (function(_React$Component) {
    ...
    BrowserRouter.prototype.render = function render() {
      return React.createElement(Router$1, {
      ...
      hashbang: {
        encodePath: function encodePath(path) {
          return path.charAt(0) === "!"
            ? path
            : "!/" + (0, PathUtils.stripLeadingSlash)(path);
        },
    ...
    var createHashHistory = function createHashHistory() {
      ...
      var handleHashChange = function handleHashChange() {
        ...
        if (path !== encodedPath) {
          ...
          if (
            !forceNextPop &&
            (0, LocationUtils.locationsAreEqual)(prevLocation, location)
          )
      ...
      var revertPop = function revertPop(fromLocation) {
        ...
        var toIndex = allPaths.lastIndexOf(
          (0, PathUtils.createPath)(toLocation)
        );

        if (toIndex === -1) toIndex = 0;

        var fromIndex = allPaths.lastIndexOf(
          (0, PathUtils.createPath)(fromLocation)
        );
          ...
          function(ok) {
            ...
            if (hashChanged) {
              ...
              var prevIndex = allPaths.lastIndexOf(
                (0, PathUtils.createPath)(history.location)
              );
    ...
    function HashRouter() {
      ...
      return (
        (_ret = ((_temp = ((_this = possibleConstructorReturn(
          ...
          _this)),
          (_this.history = createHistory$1(_this.props)),
          _temp)),
        possibleConstructorReturn(_this, _ret)
      );
    }
  ...
  var _resolvePathname$1 =
    (resolvePathname$5 && resolvePathname$3) || resolvePathname$5;
  ...
  var createTransitionManager_1$1 = createCommonjsModule(function(
    module,
    exports
  ) {
    "use strict";
    ...
    function MemoryRouter() {
      ...
      return (
        (_ret = ((_temp = ((_this = _possibleConstructorReturn$1(
          ...
          _this)),
          (_this.history = createHistory$2(_this.props)),
          _temp)),
  ...
  var NavLink = function NavLink(_ref) {
    ...
    return React.createElement(Route$1, {
      path:
        (typeof to === "undefined" ? "undefined" : _typeof$1(to)) === "object"
          ? to.pathname
          : to,
      exact: exact,
      strict: strict,
  ...
  Prompt$1.propTypes = {
    ...
    message: propTypes$1.oneOfType([propTypes$1.func, propTypes$1.string])
      .isRequired
  };
  ...
  var createLocation = function createLocation(
    ...
    if (currentLocation) {
      ...
      if (!location.pathname) {
        ...
        location.pathname = resolvePathname$3(
          location.pathname,
          currentLocation.pathname
        );
      }
  ...
  var StaticRouter$1 = (function(_React$Component) {
    ...
    StaticRouter.prototype.render = function render() {
      ...
      return React.createElement(
        Router$1,
        _extends$7({}, props, { history: history })
      );
    };
    ...
    var C = function C(props) {
      ...
      return React.createElement(Route$1, {
        render: function render(routeComponentProps) {
          return React.createElement(
            Component,
            _extends$8({}, remainingProps, routeComponentProps, {
